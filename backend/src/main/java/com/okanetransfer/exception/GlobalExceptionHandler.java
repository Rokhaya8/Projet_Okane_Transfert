...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CashDrawerAlreadyClosedException.class)
    public ResponseEntity<ErrorResponse> handleCashDrawerClosed(CashDrawerAlreadyClosedException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidTransferStatus(InvalidTransferStatusException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.CONFLICT.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    public ResponseEntity<ErrorResponse> handleInsufficientCashBalance(InsufficientCashBalanceException ex) {
        ErrorResponse error = new ErrorResponse(
